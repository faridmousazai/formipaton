<template>
  ...
  <div class="">
    ...
    <ul class="menu__box">
      ...
      <li>
        <router-link to="/createaccount" class="menu__item">Creer un Account</router-link>
      </li>
      <li v-if="!user_is_connected">
        <router-link to="/login" class="menu__item">Login</router-link>
      </li>

      <li>
        <router-link to="/Recettes" class="menu__item">Recettes</router-link>
      </li>

      <li v-if="user_is_connected">
        <router-link to="/AcceuilAdmin" class="menu__item">Acceuil Administrateur</router-link>
      </li>
      <li v-if="user_is_connected">

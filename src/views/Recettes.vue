<template>
  <div class="main">
    ...
    <div class="recette">
      <div class="image">
        <img
          src="https://fr.chatelaine.com/wp-content/uploads/2021/06/MuffinsRhubarbeOrange_580x434.jpg"
          alt="ça à l'air trop bon!"
        />
      </div>
      <div class="texte">
        <h3>Description</h3>
    ...
    <ListeIngredients
      :ingredients="recette_en_cours.associations_avec_ingredients"
    />
    <h2>Etapes</h2>
...
export default {
  ...
  computed: {
    recette_en_cours() {
      return this.$store.getters["recette/getRecetteEnCours"];
    },
  },
  created() {
    this.$store.dispatch("recette/load_recettes");
